...
```sh
  git clone https://github.com/Dorcas126/rails-backend.git
```
```sh
cd rails_backends
```
...
Feel free to check the [issues page](https://github.com/Dorcas126/rails-backend/issues).
...
- **[how can i get the front end repo link]**
  ...
  - [kindly click here](https://github.com/Dorcas126/react-frontend)
...
This project is [MIT](https://github.com/Dorcas126/rails-backend/blob/development/LICENSE) licensed.
